...
CREATE USER 'altexamuser'@'localhost' IDENTIFIED BY '987654321';
GRANT ALL PRIVILEGES ON appdb . * TO 'altexamuser'@'localhost';
...
<VirtualHost *:80>
ServerName altexamuser@localhost
